# -*- coding: utf-8 -*-
"""
Created on Sat Jan 12 22:49:21 2019
...
print (model.n_similarity('uncertainty', 'uncertaintyanalysis'))
difflib.SequenceMatcher(None, 'uncertainty', 'uncertaintyanalysis').quick_ratio()
